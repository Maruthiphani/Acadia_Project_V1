...
const SolutionCard: React.FC<SolutionCardProps> = ({ title, summary, slug, heroAccent, index }) => {
  ...
  return (
    ...
    >
      <div className={`absolute inset-0 bg-gradient-to-br ${gradientClasses[heroAccent]} transition-opacity duration-500 ${
        ...
        <div className={`transition-all duration-500 ${
          ...
          <Link
            ...
            className={`inline-flex items-center gap-2 px-6 py-3 rounded-full font-semibold transition-all duration-300 transform hover:scale-105 ${
              heroAccent === 'violet' ? 'bg-accent-violet text-white' :
              heroAccent === 'teal' ? 'bg-accent-teal text-white' :
