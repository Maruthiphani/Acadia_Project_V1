      ...
      <BackgroundWrapper variant="hero">
        <section className="py-12 sm:py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-lg sm:text-xl text-white/90 max-w-3xl mx-auto">
              Comprehensive communication services designed to transform how your
              organization operates, collaborates, and connects with customers.
            </p>
          </div>
        </section>
      </BackgroundWrapper>
      ...
      <BackgroundWrapper variant="default">
        <section className="py-12 sm:py-20">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-base sm:text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
              Contact our experts to discuss your specific needs and discover how
              our services can transform your communication infrastructure.
            </p>
            <Link
              to="/contact"
              className="inline-flex items-center gap-3 bg-gradient-brand text-white px-6 sm:px-8 py-3 sm:py-4 rounded-full font-semibold hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1"
